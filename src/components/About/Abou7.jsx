...
const Abou7 = () => {
  return (
    <div className=" min-h-screen md:h-[110vh] w-full text-[#EFEFEF] bg-[#111111] flex flex-col gap-6 md:gap-8 lg:gap-10 items-center justify-center py-12">
      {/* <div className="font-[figtree] text-sm md:text-base font-light">
        (HOBBIES)
      </div> */}
      <Bracket text="HOBBIES" className="font-[figtree] text-xl md:text-base  items-center justify-center" ></Bracket>
      ...
      <div className="flex flex-col block md:hidden text-[#EFEFEF] items-center justify-center uppercase font-[lato] text-[16px] md:text-2xl lg:text-[32px] leading-tight md:leading-relaxed lg:leading-[37px] text-center ">
       <Copy>
         <p className="text-[#efefef] whitespace-nowrap">
          Outside of creating websites, I enjoy <br /> staying active at the gym and
          
         <br />  watching exciting anime  series.
